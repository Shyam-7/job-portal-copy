...
def create_application(application: ApplicationCreate):
    ...
    try:
        ...
        # For now, using a default user for testing
        ...
        cursor.execute("""
            SELECT id, job_id, user_id, cover_letter, resume_url, full_name, email, 
                   phone, quick_apply, status, applied_at, updated_at
            FROM applications 
            WHERE id = %s
        """, (app_id,))
        app = cursor.fetchone()
...
def get_current_user_applications():
    ...
    try:
        ...
        cursor.execute("""
            SELECT a.id, a.job_id, a.user_id, a.cover_letter, a.resume_url, a.full_name,
                   a.email, a.phone, a.quick_apply, a.status, a.applied_at, a.updated_at
            FROM applications a
            WHERE a.user_id = %s
